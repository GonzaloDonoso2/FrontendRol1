    ...
    <body>
        ...
        <main>
            ...
            <div class="container form-control">                
                <h4>Personajes</h4>
                <p>Si quiere adquirir un nuevo personaje, primero debe seleccionar el personaje que desea, enviar un correo electrónico a  
                   solicitudes@perronegro.cl indicando el número de su solicitud. Luego, recibirá un correo indicando los datos bancarios 
                   de la Empresa para que realice el pago. Una vez una vez realizado éste en las próximas 48 horas tendrá a su nuevo personaje.
                </p>
            </div> 
            <br>
            <div class="container form-control" id="contenedorPersonajes" style="height: 300px; overflow-y: scroll;"></div>             
        </main>
